...
import { EntityArrayResponseType, PestService } from '../service/pest.service';
...
export class PestComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPest): number => this.pestService.getPestIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.pests = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPest[] | null): IPest[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.pestService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
