...
describe('Pest Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pest', component: PestComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to pestService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPestIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPestIdentifier).toHaveBeenCalledWith(entity);
