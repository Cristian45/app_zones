...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.personal.frontzone.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.personal.frontzone.security.DomainUserDetailsService", "createSpringSecurityUser");
