...
public class Zone implements Serializable {
    ...
    public Integer getPalmsQuantity() {
        return this.palmsQuantity;
    }

    public Zone palmsQuantity(Integer palmsQuantity) {
        this.setPalmsQuantity(palmsQuantity);
        return this;
    }
    ...
    public Zone isAffected(String isAffected) {
        this.setIsAffected(isAffected);
        return this;
    }
